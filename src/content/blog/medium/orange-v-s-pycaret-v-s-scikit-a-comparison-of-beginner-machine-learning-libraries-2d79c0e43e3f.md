...
<em>TLDR: A discussion on which of these 3 Data Science/Machine Learning libraries you should pick for your next data science / machine learning project.</em>
...
![Programming before and after machine learning! (Sourced from: Interpretable Machine Learning)](/blog-media/67b00f36a364eb69771d61febaa5f71f77f65f608801e71243c3c761fa3ae907.png)

<em>Programming before and after machine learning! (Sourced from: Interpretable Machine Learning)</em>
...
In programming, a ‘<strong>library</strong>’ is a collection of pre-written code that can be used to perform a specific task. Take the Python Pandas library, for example, it is chock-full of useful functions such as “read_csv()”, which you can use to import a CSV file into Python. Using such libraries saves programmers a lot of time because they can easily reuse pre-written code rather than writing them out from scratch every time.

Likewise, in ML, using ML libraries can save you countless precious minutes. So let’s deep-dive into the <strong>top three machine learning (ML) libraries</strong> to figure out which would best suit you.

## 1. Orange: Data Mining for Everyone

<!-- medium-image:1*uLsEjNpnRI-LTP9wCEiJUg.png alt-decision:meaningful -->

![Screenshot of the Orange website](/blog-media/f1f4f2500464dcb94c0a8e8630b5cfc509bcd39ead6ca0de5ec9868b5daa6173.png)

<em>Screenshot of the Orange website</em>

### What is Orange?

<strong><a href="https://orangedatamining.com/">Orange</a></strong><strong> </strong>is an <a href="https://github.com/biolab/orange3">open source</a> data science and machine learning toolkit. First released in 1996 by the University of Ljubljana, it has since grown into by far the most intuitive and simplistic machine learning toolkit in the world.
...
![3 Simple Steps to train a neural network in Orange](/blog-media/1f1671f5d2e1801d9da94a59c88fc4426264007c2751fc120fcf55e11dbe1ace.png)

<em>3 Simple Steps to train a neural network in Orange</em>
...
![Screenshot taken from Orange website](/blog-media/014af73d77971d22598d9129dd06b0a6b49ac01ebaadcdc1e682265f460eb886.png)

<em>Screenshot taken from Orange website</em>
...
![Orange has incredibly helpful videos on YouTube for learning data science / machine learning and using the Orange software](/blog-media/050f9a2116cd155d0f6168fbf1eb298e259957a4ad0808a106b1bde5ce986af6.png)

<em>Orange has incredibly helpful videos on YouTube for learning data science / machine learning and using the Orange software</em>
...
![Screenshot of PyCaret website](/blog-media/f6642913889b779ec530fd52c76c8349a378548d272fcdea30fbc1587c2df422.png)

<em>Screenshot of PyCaret website</em>

### What is PyCaret?

<strong><a href="https://pycaret.org/">PyCaret</a></strong> is an open-source, low-code machine learning library in Python, first released in April 2020. Compared to Orange, which relies on widgets, PyCaret involves a little bit of coding — although I must admit, it’s very minimal.
...
![Sample PyCaret code from PyCaret Docs](/blog-media/3150584379e8c8c455e7bf05533def657589c808393430bb932bb062c040ea17.png)

<em>Sample PyCaret code from PyCaret Docs</em>
...
![Sample classification task in Scikit-Learn](/blog-media/cc3c527fa8861f722fc5f324c8902ec60758682118ab0b1468319275dfbad768.png)

<em>Sample classification task in Scikit-Learn</em>
...
At the end of the day, for most purposes, any of the 3 libraries should work fine; but why limit yourself? If you plan on becoming an ML expert someday, why not take a step further and enrol in <strong>Tinkercademy’s</strong> streamlined <strong>ML training courses</strong>. Not only will you get to learn all there is to know about machine learning from an industry practitioner, but you’ll also be able to meet like-minded peers who might just end up being your future business partner!

If you or your organisation is interested in enrolling in Tinkercademy’s machine learning programmes, feel free to reach out to us at <strong><a href="mailto:hello@tk.sg">hello@tk.sg</a></strong> and we’d be glad to share more details with you!
