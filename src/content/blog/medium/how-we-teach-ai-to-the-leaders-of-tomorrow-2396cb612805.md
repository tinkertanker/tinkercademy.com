...
<a href="https://teachablemachine.withgoogle.com/">Teachable Machine</a>, a brainchild of Google Creative Lab, is one of our favourite tools we use to teach AI. Designed to make AI models less intimidating to build, Teachable Machine has achieved astounding success with over thousands of users across the globe.

<!-- medium-image:0*-Yg0pmLGDZBMuqav alt-decision:meaningful -->

![A screenshot of the Teachable Machine website](/blog-media/5fae5a3764526850c0a510350efd907f6ecfd4720b2ffe037783a00dfa116477.png)

<em>A screenshot of the Teachable Machine website</em>

As technology educators, we’ve found Teachable Machine to be effective in bringing the basics of AI to those with no prior background in programming. Its huge appeal stems from the fact that it requires <strong>zero coding</strong>!
...
![Teachable Machine guides users through making an AI. (Credits: Teachable Machine)](/blog-media/918ecc268e660fb6b4f64f19a32c3c16327e86aaf2879911e5bf5c69bb6d289e.png)

<em>Teachable Machine guides users through making an AI. (Credits: Teachable Machine)</em>
...
## <strong>Machine Learning for Kids</strong>
...
![A couple of possible ML4K AI projects that can be coded on Scratch.](/blog-media/6347b2697eb6cca37896b12eac1b3781af8339b57b79833da23e574925e7faff.png)

<em>A couple of possible ML4K AI projects that can be coded on Scratch.</em>
...
## <strong>Python ML Frameworks</strong>
